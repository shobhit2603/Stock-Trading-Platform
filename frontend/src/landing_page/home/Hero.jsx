    ...
    return (
        <section className='p-5 mb-40 mt-20'>
            <div className='flex flex-col items-center text-center'>
                <img src='/landing.svg' alt='Hero Image' className='my-6 w-200' />
                ...
                <Link to="/signup"><button className='bg-[#387ed1] text-white font-medium text-xl py-2 px-8 rounded cursor-pointer hover:bg-neutral-900'>Sign up for free</button></Link>
            </div>
        </section>
    )
}
