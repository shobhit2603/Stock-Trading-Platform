      ...
      <section className="mb-40">
        <div className="flex items-center justify-center gap-10">
          <div>
            ...
            <p className="text-neutral-500 mb-10 text-base/7">
              That's why 1.6+ crore customers trust Zerodha with ~ ₹6
              <br /> lakh crores of equity investments, making us India’s
              <br /> largest broker; contributing to 15% of daily retail
              <br /> exchange volumes in India.
            </p>
            ...
            <p className="text-neutral-500 mb-10 text-base/7">
              ...
              <a href="#" className="text-[#387ed1] hover:text-neutral-800">
                Our philosophies.
              </a>
            </p>
          ...
          <div>
            ...
            <div className="flex gap-10 ml-30 mt-10">
              <a
                href="#"
                className="text-[#387ed1] flex gap-1 hover:text-neutral-800 font-medium"
              >
                Explore our products <i class="ri-arrow-right-long-line"></i>
              </a>
              <a
                href="#"
                className="text-[#387ed1] flex gap-1 hover:text-neutral-800 font-medium"
              >
                Try Kite demo <i class="ri-arrow-right-long-line"></i>
              </a>
            </div>
          </div>
        </div>
        <img
          src="/pressLogos.png"
          alt="Press Logos"
          className="mx-auto mt-2 hover:opacity-80 cursor-pointer"
        />
      </section>
    );
}
