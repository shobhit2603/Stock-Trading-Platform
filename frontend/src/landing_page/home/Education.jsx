      ...
      <section className="mb-40">
        <div className="flex items-center justify-center gap-35">
          ...
          <div>
            ...
            <p className="text-base/7 mb-4 text-neutral-800">
            ...
            <a
              href="#"
              className="flex gap-1 text-[#387ed1] hover:text-neutral-800 font-medium mb-10"
            >
            ...
            <a
              href="#"
              className="flex gap-1 text-[#387ed1] hover:text-neutral-800 font-medium"
            >
              TrendingQ&A <i class="ri-arrow-right-long-line"></i>
            </a>
          </div>
        </div>
      </section>
